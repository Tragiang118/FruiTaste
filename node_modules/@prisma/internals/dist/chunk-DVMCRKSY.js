...
var import_chunk_IVPOBWVG = require("./chunk-IVPOBWVG.js");
var import_chunk_FIDYCH4Q = require("./chunk-FIDYCH4Q.js");
var import_chunk_USHXVHZH = require("./chunk-USHXVHZH.js");
var import_chunk_WJPDCCIW = require("./chunk-WJPDCCIW.js");
...
async function formatSchema({ schemas }, inputFormattingOptions) {
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(() => {
    ...
    const lintDiagnostics2 = (0, import_chunk_FIDYCH4Q.lintSchema)({ schemas: formattedMultipleSchemas2 });
    return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
  });
  const lintWarnings = (0, import_chunk_FIDYCH4Q.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_AYKHFUHB.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function processSchemaResult({
  ...
  const configFromPsl = await (0, import_chunk_WJPDCCIW.getConfig)({ datamodel: schemaResult.schemas });
...
async function getGenerators(options) {
  ...
  const dmmf = await (0, import_chunk_IVPOBWVG.getDMMF)({ datamodel: schemaContext.schemaFiles });
...
You need to define \`output\` in the generator block in the schema file.`
        ...
        const datamodel = (0, import_chunk_USHXVHZH.mergeSchemas)({ schemas: schemaContext.schemaFiles });
        const options2 = {
          datamodel,
