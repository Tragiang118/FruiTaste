...
var chunk_6PRHDXET_exports = {};
__export(chunk_6PRHDXET_exports, {
  GetConfigError: () => GetConfigError,
  getConfig: () => getConfig
});
module.exports = __toCommonJS(chunk_6PRHDXET_exports);
...
[Context: getConfig]`;
    super((0, import_chunk_UUYDRB5L.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        return import_chunk_CFKXSAMV.prismaSchemaWasm.get_config(params);
      },
      (e) => ({
        type: "wasm-error",
