        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
              Được thành lập vào năm 2026, FruiTaste ra đời với mục tiêu đơn giản là giúp người tiêu dùng thành thị dễ dàng tiếp cận nguồn hoa quả tươi sạch, rõ ràng nguồn gốc xuất xứ.
            </p>
            <p className="text-gray-500 text-xs md:text-sm leading-relaxed">
