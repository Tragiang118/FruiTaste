                        ...
                        <CardContent className="p-3 sm:p-4 flex flex-col gap-3">
                          ...
                          {type === 'import' && (
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-2.5 border-t border-gray-50">
                              ...
                              <div className="space-y-1">
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 block">Giá bán thủ công (đ)</label>
                                <Input
                                  type="text"
                                    ...
                                    <PopoverContent className="w-72 p-4 rounded-2xl shadow-2xl border-amber-50 bg-white" align="end">
                                      {(() => {
                                        ...
                                        if (manualPrice > 0) {
                                          ...
                                          const actualMarginPercent = effectiveCost > 0 ? Math.round((profitAmount / effectiveCost) * 100) : 0;
